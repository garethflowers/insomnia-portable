...
user in an INI file next to InsomniaPortable.exe called InsomniaPortable.ini.
...
copy AppNamePortable.ini from this directory to InsomniaPortable.ini next to
InsomniaPortable.exe. The options in the INI file are as follows:
